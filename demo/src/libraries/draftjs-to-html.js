(function(global, factory) {
    ...
    function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
        ...
        if (entity.type === "IMAGE") {
            ...
            return '<img src="' + entity.data.src + '" alt="' + entity.data.alt + '" style="float:' + (entity.data.alignment || "none") + ";height: " + entity.data.height + ";min-width: 375px" + ";background:"+ entity.data.background + ";padding:"+ entity.data.padding + ";width:" + entity.data.width + '"/>';
        }
